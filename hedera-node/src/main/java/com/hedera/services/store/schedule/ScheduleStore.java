...
public interface ScheduleStore extends Store<ScheduleID, MerkleSchedule> {
	...
	CreationResult<ScheduleID> createProvisionally(byte[] bodyBytes, Optional<byte[]> txMemo, AccountID payer, AccountID schedulingAccount, RichInstant schedulingTXValidStart, Optional<JKey> adminKey);
